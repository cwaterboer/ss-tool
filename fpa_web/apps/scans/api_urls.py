...
urlpatterns = [
    ...
    path('sites/<uuid:site_id>/scans/list/', api_views.ScanListAPIView.as_view(), name='api-scan-list'),
    path('sites/<uuid:site_id>/scans/<uuid:scan_id>/', api_views.ScanDetailAPIView.as_view(), name='api-scan-detail'),
